      ...
      <div
        className={
          nav
            ...
            : 'fixed left-[-100%] top-20 h-[80%] flex flex-col items-center justify-between ease-in duration-300'
        }
      >
        ...
        <div className='flex flex-col w-full p-4 '>
          ...
          <Link to='/signup'>
            <button
              onClick={handleNav}
              className='w-full my-2 p-3 bg-button text-btnText rounded-2xl shadow-lg'
            >
              Sign Up
            </button>
          </Link>
