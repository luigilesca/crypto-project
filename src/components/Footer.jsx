...
const Footer = () => {
  return (
    <div className='rounded-div mt-8 pt-8 text-primary'>
      ...
      <p className='w-full text-center py-4 flex items-center justify-center '>
        Made with <AiFillHeart color='red' className='mx-2' /> by{' '}
        <span className='ml-2 hover:text-accent hover:font-bold'>
          <a
            className='font-semibold'
            href='https://www.linkedin.com/in/luigi-lesca/'
            target='_blank'
          >
            Luigi Lesca
          </a>
